...
STANDARD_SCENARIOS: list[Scenario] = [
    ...
    _dense(
        ...
        qwen36=True,
        source_row=7,
        source_column="910B optimized + reused MemCache",
        source_cell_refs=("I7", "J6"),
    ),
    _moe(
...
REUSE_SCENARIOS: list[Scenario] = [
    _moe(
        ...
        is_reuse=True,
        notes="910B row is not measured in the source workbook; config intentionally reuses 910C MemCache.",
    ),
    _moe(
