#!/bin/bash
# Qwen3.6-27B feature run on 910C: MemCache offload + MTP.
set +e

MODEL_DIR=${MODEL_DIR:-/var/aispace/model/ai-storage/ai-prod/platform/Qwen3.6-27B}
...
LOG_FILE="$LOG_DIR/qwen36_27b_910c_memcache-$(date +%Y%m%d_%H%M%S).log"
