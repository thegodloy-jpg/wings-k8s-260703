#!/bin/bash
# Qwen3.6-35B-A3B-w8a8 feature run on 910B: MemCache offload + EP + MTP.
set +e
...
LOG_DIR=${LOG_DIR:-/home/swl/source/day0/qwen36_910b3/logs}
mkdir -p "$LOG_DIR"
...
LOG_FILE="$LOG_DIR/qwen36_35b_a3b_w8a8_910b_memcache-$(date +%Y%m%d_%H%M%S).log"
