#!/bin/bash
# Qwen3.6-35B-A3B feature run on 910C: MemCache offload + EP + MTP.
set +e

MODEL_DIR=${MODEL_DIR:-/var/aispace/model/ai-storage/ai-prod/platform/Qwen3.6-35B-A3B}
...
LOG_FILE="$LOG_DIR/qwen36_35b_a3b_910c_memcache-$(date +%Y%m%d_%H%M%S).log"
...
vllm serve "$MODEL_DIR" \
    ...
    --additional-config '{"enable_cpu_binding":true,"multistream_overlap_shared_expert":true,"ascend_compilation_config":{"enable_npugraph_ex":true}}' \
